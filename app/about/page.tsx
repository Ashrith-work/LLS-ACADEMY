...
export const metadata: Metadata = {
  title: "Shashank story — guru kaadu, mee laane struggle chesina manishi",
  description:
    "Engineering → sales floor → Luxury Escapes regional director → IIM Lucknow → bootstrapped founder. Shashank journey, honest ga.",
};
        ...
        <section className="bg-ink px-4 py-16 text-center sm:py-24">
          <Reveal>
            ...
            <p className="mx-auto mt-5 max-w-xl text-muted">
              {SITE.instagramReach} Telugu vaallaki reach — kaani story start chinna ga, mee laane.
            </p>
          </Reveal>
        </section>
          ...
          <div className="mx-auto max-w-2xl px-4">
            ...
            <Reveal>
              <div className="mt-16 rounded-3xl bg-inkText p-8 text-center text-bone">
                <h2 className="font-display text-2xl">Ippudu mee vantu.</h2>
                <p className="mt-3 text-sm text-bone/70">
                  2 questions — mee goal ki correct course chupistam. 30 seconds.
                </p>
                <div className="mt-6">
