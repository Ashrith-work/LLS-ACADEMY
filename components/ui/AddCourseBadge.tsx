...
export function AddCourseBadge() {
  return (
    <Link
      ...
      className="fixed bottom-6 left-6 z-50 inline-flex items-center gap-2.5 rounded-lg px-6 py-3 text-lg font-bold text-accentFg shadow-cardLift transition-all hover:-translate-y-0.5 hover:brightness-95 select-none"
