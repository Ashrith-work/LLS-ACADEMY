...
export function AddCourseBadge() {
  return (
    <Link
      ...
      className="fixed bottom-6 left-6 z-50 inline-flex items-center gap-2.5 rounded-lg bg-ink px-6 py-3.5 text-lg font-semibold text-white shadow-cardLift transition-all hover:-translate-y-0.5 hover:bg-ink/90 select-none"
    >
