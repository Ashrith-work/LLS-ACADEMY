...
export function AddCourseBadge() {
  return (
    <Link
      ...
      className="fixed bottom-6 left-6 z-50 inline-flex items-center gap-2.5 rounded-lg px-4 py-2 text-sm font-bold text-white shadow-cardLift transition-all hover:-translate-y-0.5 hover:brightness-95 select-none"
