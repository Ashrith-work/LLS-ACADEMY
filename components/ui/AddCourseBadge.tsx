...
export function AddCourseBadge() {
  return (
    <Link
      ...
      className="fixed bottom-6 left-6 z-50 inline-flex items-center gap-2.5 rounded-lg px-7 py-4 text-2xl font-semibold text-white shadow-cardLift transition-all hover:-translate-y-0.5 hover:brightness-95 select-none"
